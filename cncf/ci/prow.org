...
#+RESULTS:
#+BEGIN_EXAMPLE :noeval t
time="2019-04-28T09:46:27Z" level=warning msg="the following jobs use the kubernetes provider but do not use the pod utilities: [ci-kubernetes-gce-conformance]" component=checkconfig
time="2019-04-28T09:46:27Z" level=warning msg="unknown fields present in config.yaml: approve, blockades, blunderbuss, containers, label, lgtm, plugins, project_config, repo_milestone, require_matching_label, size, triggers, welcome" component=checkconfig
time="2019-04-28T09:46:27Z" level=warning msg="unknown fields present in plugins.yaml: containers, deck, periodics, plank, presubmits" component=checkconfig
ExitCode: 0
#+END_EXAMPLE
...
#+BEGIN_SRC yaml
  ...
  - missing_label: data-gen
    ...
    prs: true
    regexp: ^data-gen/
    missing_comment: "Must tag with data-get to modify anything under ./data-gen/"
#+END_SRC
** plugins
...
. ~/githubtoken
curl --user hh:$GITHUB_TOKEN  -H "Accept:application/vnd.github.inertia-preview+json" https://api.github.com/orgs/ii-ci/teams/automation | jq .id
#+END_SRC
...
#+RESULTS:
| /home/pair/test-infra/hook-plugin.yaml | /home/pair/test-infra/hook-config.yaml | /home/pair/org/cncf/ci/plugins.yaml | /home/pair/org/cncf/ci/labels.yaml | /home/pair/org/cncf/ci/config.yaml | /home/pair/test-infra/comment.json | /home/pair/org/cncf/ci/github-oauth-config |
...
#+RESULTS:
#+BEGIN_EXAMPLE :noeval t
pod "hook-86d9f6dfc6-b69x8" deleted
pod "hook-86d9f6dfc6-jtwj8" deleted
pod "plank-564d8c4b8b-ztm4q" deleted
#+END_EXAMPLE
