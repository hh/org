...
#+BEGIN_SRC shell :wrap 'SRC txt' :results replace code output :wrap "SRC text"
  kubectl config set-context $(kubectl config current-context) --namespace ${NAMESPACE:-binder2}
  kubectl get pod 
#+END_SRC
...
Context "gke_apisnoop_australia-southeast1-c_apisnoop-jupyterhub" modified.
NAME                          READY   STATUS    RESTARTS   AGE
binder-7bb99ff8d4-754dh       1/1     Running   0          1h
binder2-image-cleaner-dql9f   1/1     Running   0          1h
binder2-image-cleaner-mmkvh   1/1     Running   0          1h
hub-857c754f9-zm97r           1/1     Running   0          1h
proxy-cb664c65c-577q8         1/1     Running   0          1h
#+END_SRC
...
Context "gke_apisnoop_australia-southeast1-c_apisnoop-jupyterhub" modified.
NAME           TYPE           CLUSTER-IP     EXTERNAL-IP    PORT(S)                      AGE
binder         LoadBalancer   10.3.243.24    35.189.32.76   80:32138/TCP                 1h
hub            ClusterIP      10.3.251.163   <none>         8081/TCP                     1h
proxy-api      ClusterIP      10.3.242.242   <none>         8001/TCP                     1h
proxy-public   LoadBalancer   10.3.243.141   35.189.36.7    80:30392/TCP,443:30135/TCP   1h
#+END_SRC
