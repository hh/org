...
#+TITLE: Cluster-API + Talos + Equinix Metal
...
#+HUGO_TAGS: kubernetes talos equinix
#+HUGO_CATEGORIES: guides
#+FIRN_SUMMARY: A guide to  launching a highly-available cluster with Equinix and Talos
