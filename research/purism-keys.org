...
* Footnotes
#+PROPERTY: FOO for some reason I can't seem to move functions as header args into .dir-locals.el
#+PROPERTY: URL https://emacs.stackexchange.com/questions/26185/using-a-function-as-an-org-babel-header-argument
