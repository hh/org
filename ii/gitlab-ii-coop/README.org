...
#+begin_src tmate
kubectl -n gitlab-ii-coop get machines,clusters,packetmachines,packetclusters
#+end_src
...
curl -L -o ./rook-ceph-common.yaml https://github.com/rook/rook/raw/master/cluster/examples/kubernetes/ceph/common.yaml
curl -L -o ./rook-ceph-crds.yaml https://github.com/rook/rook/raw/master/cluster/examples/kubernetes/ceph/crds.yaml
curl -L -o ./rook-ceph-operator.yaml https://github.com/rook/rook/raw/master/cluster/examples/kubernetes/ceph/operator.yaml
#+end_src
