...
Unable to use a TTY - input is not a terminal or the right kind of file
total 6M
drwxrwxrwx   11 root     root        4.0K Jul  6 01:42 .
drwxr-xr-x    3 root     root          18 Jul  6 01:33 ..
drwxr-xr-x    2 root     root         175 Jul  6 01:42 2bbd241a
drwxr-xr-x    2 root     root         175 Jul  6 01:42 2cb186c5
-rw-r--r--    1 1000     1000        1.9M Jul  6 01:42 RPI_EFI.fd
-rw-r--r--    1 1000     1000        5.3K Jul  6 01:42 Readme.md
drwxr-xr-x    2 root     root         175 Jul  6 01:42 bc3ebf28
drwxr-xr-x    2 root     root         175 Jul  6 01:42 bc3ef28
-rw-r--r--    1 1000     1000       48.1K Jul  6 01:42 bcm2711-rpi-4-b.dtb
-rw-r--r--    1 1000     1000       48.1K Jul  6 01:42 bcm2711-rpi-400.dtb
-rw-r--r--    1 1000     1000       48.7K Jul  6 01:42 bcm2711-rpi-cm4.dtb
drwxr-xr-x    2 root     root         175 Jul  6 01:42 c3052218
-rw-r--r--    1 1000     1000         206 Jul  6 01:42 config.txt
drwxr-xr-x    2 root     root         175 Jul  6 01:42 dd24784d
drwxr-xr-x    2 root     root         175 Jul  6 01:42 ebc28a3f
drwxr-xr-x    3 root     root          55 Jul  6 01:42 firmware
-rw-r--r--    1 1000     1000        5.3K Jul  6 01:42 fixup4.dat
-rw-r--r--    1 1000     1000      968.6K Jul  5 04:04 ipxe-arm64.efi
-rw-r--r--    1 1000     1000      996.5K Jul  5 04:04 ipxe.efi
drwxr-xr-x    2 root     root          30 Jul  6 01:42 overlays
-rw-r--r--    1 1000     1000        2.1M Jul  6 01:42 start4.elf
...
1. Fetch a release of RPI4_UEFI firmware (currently using /v1.26/)
2. Write the contents of the zip file to a fat32 formatted microSD card
3. Insert and boot the microSD card
4. Enter the UEFI set up

*** Configure the UEFI firmware
1. Remove Memory limit: In /Device Manager -> Raspberry Pi Configuration -> Advanced Configuration/, set /Limit RAM to 3 GB/ to /Disabled/; F10 to save.
2. Max out CPU clock: In /Device Manager -> Raspberry Pi Configuration -> CPU Configuration/, set /CPU clock/ to /Max/; F10 + Y to save.
3. Declare the iPXE HTTP boot URI: In /Device Manager -> Network Device List -> <MAC ADDRESS> -> HTTP Boot Configuration/, set /Boot URI/ to http://boot.ii.nz/tftp/ipxe-arm64.efi, set /Name/ to /boot.ii.nz/; F10 + Y to save.
4. Tidy up the boot order: In /Boot Maintenance Manager -> Boot Options -> Change Boot Order/, ensure that the following options remain (in no specific order):
   - /boot.ii.nz/
   - /SD/MMC .../
