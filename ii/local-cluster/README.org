...
-rw-r--r--    1 root     root      968.6K Jul  2 06:27 ipxe-arm64.efi
-rw-r--r--    1 root     root      996.5K Jul  2 06:27 ipxe.efi
-rw-r--r--    1 root     root       81.0K Jul  2 06:27 undionly.kpxe
-rw-r--r--    1 root     root       81.0K Jul  2 06:27 undionly.kpxe.0
#+end_example
...
Prepare script for setting up RPis with boot files
#+NAME: tftp-root-setup
#+begin_src shell :comments none :prologue "" :epilogue ""
UUIDs="2cb186c5"
FILES="start4.elf fixup4.dat config.txt RPI_EFI.fd ipxe.efi ipxe-arm64.efi firmware overlays bcm2711-rpi-4-b.dtb"
...
Create symlinks for boot files based on the RPi's UUID
#+begin_src tmate :window prepare :noweb yes
kubectl -n sidero-system exec -it sidero-debug -- sh -x -c '
<<tftp-root-setup>>
'
#+end_src
...
#+RESULTS:
#+begin_example
configmap/dnsmasq-config created
persistentvolumeclaim/dnsmasq-tftp created
deployment.apps/dnsmasq created
#+end_example
...
Unable to use a TTY - input is not a terminal or the right kind of file
total 6M
drwxrwxrwx   10 root     root        4.0K Jul  2 06:59 .
drwxr-xr-x    3 root     root          18 Jul  2 06:33 ..
drwxr-xr-x    2 root     root         175 Jul  2 06:59 2bbd241a
drwxr-xr-x    2 root     root         175 Jul  2 06:59 2cb186c5
-rw-r--r--    1 1000     1000        1.9M Jul  2 06:59 RPI_EFI.fd
-rw-r--r--    1 1000     1000        5.3K Jul  2 06:59 Readme.md
drwxr-xr-x    2 root     root         175 Jul  2 06:59 bc3ef28
-rw-r--r--    1 1000     1000       48.1K Jul  2 06:59 bcm2711-rpi-4-b.dtb
-rw-r--r--    1 1000     1000       48.1K Jul  2 06:59 bcm2711-rpi-400.dtb
-rw-r--r--    1 1000     1000       48.7K Jul  2 06:59 bcm2711-rpi-cm4.dtb
drwxr-xr-x    2 root     root         175 Jul  2 06:59 c3052218
-rw-r--r--    1 1000     1000         206 Jul  2 06:59 config.txt
drwxr-xr-x    2 root     root         175 Jul  2 06:59 dd24784d
drwxr-xr-x    2 root     root         175 Jul  2 06:59 ebc28a3f
drwxr-xr-x    3 root     root          55 Jul  2 06:59 firmware
-rw-r--r--    1 1000     1000        5.3K Jul  2 06:59 fixup4.dat
-rw-r--r--    1 1000     1000      968.6K Jul  2 06:59 ipxe-arm64.efi
-rw-r--r--    1 1000     1000      996.5K Jul  2 06:59 ipxe.efi
drwxr-xr-x    2 root     root          30 Jul  2 06:59 overlays
-rw-r--r--    1 1000     1000        2.1M Jul  2 06:59 start4.elf
-rw-r--r--    1 1000     1000       81.0K Jul  2 06:59 undionly.kpxe
-rw-r--r--    1 1000     1000       81.0K Jul  2 06:59 undionly.kpxe.0
#+end_example
...
clusterctl config cluster -n local-clusters local-cluster-mgmt -i sidero > ./sidero/local-clusters/local-cluster-mgmt.yaml
#+end_src
...
#+begin_src shell
kubectl get servers,machines,clusters -A
#+end_src

#+RESULTS:
#+begin_example
NAME                                                           HOSTNAME        ACCEPTED   ALLOCATED   CLEAN   POWER
server.metal.sidero.dev/00c03111-0000-0000-0000-dca63203f59a   192.168.1.207   true       true        false   on

NAMESPACE        NAME                                                   PROVIDERID   PHASE          VERSION
local-clusters   machine.cluster.x-k8s.io/local-cluster-mgmt-cp-mtrv2                Provisioning   v1.20.1
