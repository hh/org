...
#+begin_src yaml :tangle ./sidero-cm-debug.yaml
apiVersion: v1
kind: Pod
metadata:
  name: sidero-debug
...
#+begin_src shell
kubectl apply -f ./sidero-cm-debug.yaml
#+end_src
...
pxe-service=0,"PXE boot",192.168.1.21
dhcp-boot=/var/lib/sidero/tftp,boothost,192.168.1.21
#+end_src
