...
#+NAME: Display help
#+BEGIN_SRC shell :dir ~/org/ii/google/ :output raw :results raw code :wrap "SRC text"
...
optional arguments:
  ...
  --user-agent USER_AGENT
                        ...
                        "". (default: CertbotACMEClient/0.27.1 (certbot-auto;
                        Debian GNU/Linux 9 (stretch)) Authenticator/XXX
                        Installer/YYY (SUBCOMMAND; flags: FLAGS) Py/2.7.13).
...
#+RESULTS: certbot request for *.crt.cncf.ci which fails
#+BEGIN_SRC shell
