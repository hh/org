...
#+BEGIN_SRC yaml :tangle (concat "/ssh:" ssh-user-host ":kubeadm-config.yaml")
  ...
  nodePortAddresses: [] # "" # default is null
  portRange: "22-60000"
#+END_SRC

#+NAME: using a config file to set kubeadm config options
#+BEGIN_SRC tmate :eval ask
  kubeadm reset --force
  kubeadm init --config kubeadm-config.yaml
  # --kube-proxy-nodeport-addresses=139.178.88.144/29 \
